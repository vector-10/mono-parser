    ...
    <>
      ...
      >
        ...
        >
          <Link href="/" className="flex items-center gap-2">
            <span className="text-lg sm:text-xl font-bold text-[#0055ba]">
              Mono-Parser
            </span>
          </Link>
          ...
          <nav className="hidden items-center gap-4 lg:gap-6 xl:gap-8 text-xs sm:text-sm font-semibold text-gray-600 md:flex">
            <a
              href="#features"
              className="hover:text-[#0055ba] transition-colors whitespace-nowrap"
            >
              Features
            </a>
            <a
            ...
            <Link
              href="/docs"
              className="flex items-center gap-1.5 hover:text-[#0055ba] transition-colors whitespace-nowrap"
            >
      ...
      >
        <div className="flex items-center justify-between p-3 sm:p-6 border-b border-gray-100">
          <span className="text-base sm:text-lg font-bold text-[#0055ba]">
            Parser
          </span>
          <button
            onClick={() => setMobileMenuOpen(false)}
