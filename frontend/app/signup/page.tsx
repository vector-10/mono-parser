...
import { signupSchema, type SignupFormData, verifyOtpSchema, type VerifyOtpFormData } from '@/lib/validations/auth'
                ...
                <form onSubmit={handleSignupSubmit(onSignup)} className="space-y-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0055ba] focus:border-transparent ${
                        signupErrors.companyName ? 'border-red-500' : 'border-gray-300'
                      }`}
                      placeholder="Your Company Ltd"
                    />
                    {signupErrors.companyName && (
                      <p className="mt-1 text-sm text-red-600">{signupErrors.companyName.message}</p>
                    )}
                  </div>
