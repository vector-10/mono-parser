...
import { ArrowRight, Zap, BarChart3, Lock, CheckCircle, Code, Globe, Menu, X, TrendingUp, Shield } from 'lucide-react';
      ...
      <header className="sticky top-0 z-40 border-b border-gray-100 bg-white/80 backdrop-blur-sm">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4">
          ...
          <nav className="hidden items-center gap-8 text-sm md:flex">
            ...
            <a href="#reasons" className="text-gray-600 hover:text-gray-900 transition">Why Us</a>
            <a href="#api" className="text-gray-600 hover:text-gray-900 transition">API</a>
          </nav>

          <div className="flex items-center gap-3">
            <Link href="/login" className="hidden md:inline-flex items-center gap-2 rounded-lg bg-[#0055ba] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#004494] transition">
      ...
      <div className={`fixed top-0 right-0 h-full w-80 bg-white shadow-2xl transform transition-transform duration-300 ease-in-out z-50 md:hidden ${
        ...
        <div className="p-6 space-y-6 flex flex-col h-full">
          <div className="space-y-6 flex-1">
            <a href="#features" onClick={() => setIsMobileMenuOpen(false)} className="block py-3 text-gray-600 hover:text-gray-900 border-b border-gray-100 transition">Features</a>
            <a href="#reasons" onClick={() => setIsMobileMenuOpen(false)} className="block py-3 text-gray-600 hover:text-gray-900 border-b border-gray-100 transition">Why Us</a>
            <a href="#api" onClick={() => setIsMobileMenuOpen(false)} className="block py-3 text-gray-600 hover:text-gray-900 border-b border-gray-100 transition">API</a>
          </div>

          <div className="mt-auto pt-6 border-t border-gray-100">
            <Link href="/login" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center justify-center gap-2 rounded-lg bg-[#0055ba] px-4 py-3 text-sm font-semibold text-white hover:bg-[#004494] transition">
              Get Started <ArrowRight className="h-4 w-4" />
            </Link>
      ...
      <section className="relative mx-auto max-w-6xl px-4 pt-24 pb-20 text-center">
        <div className="space-y-8 scroll-reveal">
          ...
          <div className="flex flex-wrap justify-center gap-4 pt-4">
            <Link href="/signup" className="inline-flex items-center gap-2 rounded-lg bg-[#0055ba] px-8 py-4 text-base font-semibold text-white hover:bg-[#004494] transition shadow-lg shadow-[#0055ba]/20">
              Request Demo <ArrowRight className="h-5 w-5" />
            </Link>
            <a href="#api" className="rounded-lg border-2 border-gray-200 bg-white px-8 py-4 text-base font-semibold text-gray-900 hover:border-gray-300 transition">
              View API Docs
            </a>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white rounded-xl border border-gray-200 p-8 hover:shadow-lg transition scroll-reveal">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 scroll-reveal">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Traditional credit scores tell part of the story. We analyze the full picture.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="p-6 bg-white border-2 border-gray-100 rounded-xl hover:border-[#59a927] transition scroll-reveal">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="scroll-reveal">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Integrate credit scoring into your lending platform in minutes. RESTful API with comprehensive documentation.
              </p>
              <ul className="space-y-4 mb-8">
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-[#59a927] flex-shrink-0 mt-0.5" />
                  <span className="text-gray-300">Multi-tenant architecture for security</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-[#59a927] flex-shrink-0 mt-0.5" />
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-[#59a927] flex-shrink-0 mt-0.5" />
                  <span className="text-gray-300">Comprehensive error handling</span>
                </li>
              </ul>
              <Link href="/docs" className="inline-flex items-center gap-2 px-6 py-3 text-base font-medium text-[#010101] bg-white rounded-lg hover:bg-gray-100 transition">
                View Documentation
        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-gradient-to-br from-[#0055ba] to-[#003d85] rounded-2xl p-12 text-center text-white shadow-2xl scroll-reveal">
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Join Nigerian fintechs using Mono-Parser to reduce default rates and approve more loans.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/signup" className="inline-flex items-center justify-center gap-2 px-8 py-4 text-lg font-semibold bg-white text-[#0055ba] rounded-lg hover:bg-gray-100 transition">
                Get API Access
                <ArrowRight className="h-5 w-5" />
              </Link>
              <a href="mailto:contact@mono-parser.com" className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold bg-transparent border-2 border-white text-white rounded-lg hover:bg-white/10 transition">
                Talk to Sales
              </a>
            </div>
          </div>
