...
- Credit Score: ${analysisData.score}
- Decision: ${analysisData.decision?.decision || 'N/A'}
- Recommended Amount: ₦${analysisData.decision?.recommended_amount?.toLocaleString() || 'N/A'}
- Interest Rate: ${analysisData.decision?.interest_rate || 'N/A'}%
- Tenor: ${analysisData.decision?.tenor || 'N/A'} months

Key Factors:
${JSON.stringify(analysisData.decision?.reasoning || {}, null, 2)}

Provide a clear, professional explanation of:
1. Why this decision was made
2. The most important factors that influenced it
3. Any risks or concerns to be aware of
